...
LEXERS = {
    ...
    'Notation3Lexer': ('pygments.lexers.sw', 'N3', ('n3', 'turtle'), ('*.n3', '*.ttl', '*.NT'), ('text/rdf+n3', 'application/x-turtle', 'application/n3')),
    ...
    'SparqlLexer': ('pygments.lexers.sw', 'SPARQL', ('sparql',), ('*.sparql',), ('text/x-sql',)),
